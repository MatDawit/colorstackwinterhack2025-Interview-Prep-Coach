...
export default function Dashboard() {
  ...
  return (
    <>
      <Navbar />
      <div className={`min-h-screen pt-20 mt-13 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className={`shadow-xl rounded-xl p-6 space-y-4 w-full ${
            isDarkMode ? 'bg-gray-800' : 'bg-white'
          }`}>
            <div className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>
              Welcome to InterviewAI!
            </div>
            <div className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-300' : 'text-black'}`}>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className={`shadow-xl rounded-xl w-full p-6 space-y-3 ${
              isDarkMode ? 'bg-gray-800' : 'bg-white'
            }`}>
            ...
            <div className={`shadow-xl rounded-xl p-6 space-y-4 w-full ${
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {loading ? (
                    <span className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>...</span>
                  ) : (
                ...
                <div className="mt-4">
                  <h3 className={`text-sm font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-black'}`}>
