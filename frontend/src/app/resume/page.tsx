...
export default function ResumePage() {
  ...
  useEffect(() => {
    async function loadResume() {
      ...
      try {
        ...
        if (!res.ok)
          throw new Error(data.error || "Failed to load resume metadata");
        ...
        if (data.resume) {
          ...
          try {
            const parsedRes = await fetch(
              `${API_URL}/api/profile/resume/parse`,
              {
                headers: { Authorization: `Bearer ${token}` },
              }
            );
  ...
  async function reparseResume() {
    ...
    try {
      setParsing(true);
      const parsedRes = await fetch(`${API_URL}/api/profile/resume/parse`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  async function generateFeedback() {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/resume/feedback`, {
        method: "POST",
        headers: {
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    Parse your resume, verify/edit details, and get AI-powered
                    feedback.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <RefreshCcw
                    className={`h-4 w-4 ${parsing ? "animate-spin" : ""}`}
                  />
              ...
              <div className="h-[720px] w-full">
                {loading ? (
                  ...
                  <div className="h-full w-full flex flex-col items-center justify-center gap-3 px-6">
                    ...
                    >
                      Go to Profile → Account → Resume to upload a PDF. Once
                      uploaded, it will show here.
                    </p>
                  </div>
                )}
              </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Verify and edit anything that looks off. These fields will
                    power personalized feedback.
                  </p>
                </div>
              </div>
                ...
                {parsed ? (
                  <>
                    <TextField
                      ...
                      onChange={(v) =>
                        setParsed((p) => (p ? { ...p, headline: v } : null))
                      }
                    ...
                    <TextArea
                      ...
                      onChange={(v) =>
                        setParsed((p) => (p ? { ...p, summary: v } : null))
                      }
                      isDarkMode={isDarkMode}
                    ...
                    <TagsEditor
                      ...
                      tags={parsed.skills}
                      onChange={(tags) =>
                        setParsed((p) => (p ? { ...p, skills: tags } : null))
                      }
                      isDarkMode={isDarkMode}
                    />
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Get personalized feedback on your resume from our AI career
                    coach
                  </p>
                </div>
              </div>
              ...
              >
                <Sparkles
                  className={`h-4 w-4 ${loadingFeedback ? "animate-spin" : ""}`}
                />
            ...
            {feedback ? (
              ...
              <div
                className={`mt-6 rounded-lg border-2 border-dashed p-12 text-center ${
