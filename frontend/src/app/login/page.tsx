...
export default function Login() {
    ...
    return (
        <div className={`min-h-screen flex justify-center items-center px-4 py-8 sm:py-12 md:py-20 ${
            isDarkMode 
            ...
            {/* Main Login Card */}
            <div className={`rounded-xl shadow-xl p-6 sm:p-8 w-full max-w-md ${
            ...
            {showErrorModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className={`rounded-2xl shadow-2xl p-6 sm:p-8 max-w-sm w-full mx-4 relative animate-fadeIn ${
                        isDarkMode ? 'bg-gray-800' : 'bg-white'
                    }`}>
                        {/* Close button */}
                        <button
