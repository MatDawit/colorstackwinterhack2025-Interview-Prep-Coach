  ...
  useEffect(() => {
    ...
    async function loadAccount() {
      ...
      try {
        ...
        if (!resumeRes.ok)
          throw new Error(resumeData.error || "Failed to load resume");
            ...
            <main className="min-w-0">
              <div className="max-w-4xl">
                ...
                >
                  ...
                  >
                    Tip: If you sign in with Google or GitHub, we'll link
                    accounts by email (when available).
                  </p>
                </section>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      >
                        Upload your resume to personalize interview questions
                        and feedback.
                      </p>
                    </div>
                  ...
                  >
                    {account.resumeFileName ? (
                      <div className="flex items-start gap-3">
                        <div
                          className={`mt-0.5 h-10 w-10 rounded-lg border flex items-center justify-center ${
                            isDarkMode
                        ...
                        <div className="min-w-0">
                          ...
                          >
                            We'll use your resume to tailor questions and
                            highlight skill gaps during practice.
                          </p>
                        </div>
                      </div>
                    ) : (
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          >
                            Upload a PDF or Word document to personalize your
                            practice sessions.
                          </p>
                        </div>
                      </div>
                ...
                >
                  ...
                  >
                    If you signed up with Google/GitHub only, password features
                    may be unavailable until you set a password.
                  </p>
                </section>
