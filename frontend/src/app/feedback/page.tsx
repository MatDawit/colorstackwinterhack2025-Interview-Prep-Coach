        ...
        <div className="max-w-[1000px] mx-auto px-6 pt-32 pb-12">
          ...
          <section className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm mt-8">
            ...
            <div className="text-[15px] leading-relaxed text-gray-600 space-y-4">
              ...
              <p>
                However, consider refining your Task description for more
                clarity and detail. Additionally, eliminate filler words to
                enhance your professional delivery. Focus on a strong, confident
                closing statement to reinforce your achievements.
              </p>
            </div>
          </section>
          {/* Better Version Card */}
          <section className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm mt-8">
            ...
            <div className="bg-[#F9FAFB] p-8 rounded-xl border border-gray-200">
              <p className="text-[15px] leading-[1.8] text-gray-700">
                In my previous role at TechCorp, our primary server experienced
                a critical outage, jeopardizing service continuity. My objective
                was to restore functionality with minimal downtime. I initiated
                an immediate assessment, coordinating with the network team to
                ...
                critical importance of proactive system monitoring and
                maintaining robust, well-tested disaster recovery protocols.
              </p>
            </div>
          </section>
